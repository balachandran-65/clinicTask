<div>
    <div>
      {{-- Session Value: {{ session('my_session_variabl') }}{{ session('doctor_id') }} --}}
        ...
        <div class=" lg:bg-black/40 lg:px-80 lg:pt-28 lg:pb-80"> <!-- main div open  -->
          <div class="container mx-auto lg:bg-white rounded-xl"> <!-- parent div open  -->
            ...
            <div class="container mx-auto px-4">
              <div class="lg:grid-cols-2 lg:grid lg:gap-8 lg:items-center">
                ...
                <div class=" hidden lg:block">
                  ...
                  <input type="text" name="" id="" id="" wire:model="email"
                    class="mt-2 focus:outline-none pl-4 shadow-[0px_1px_3px_0px_rgba(0, 0, 0, 0.07)]  border border-gray-300 rounded-lg w-full py-2">
              ...
              <div class=" py-4 lg:py-3">
                ...
                <input type="number" name="" id="" id="" wire:model="phoneNumber"
                  ...
                  @error('phoneNumber') <span class="error text-red-500">{{ $message }}</span> @enderror
              </div>
      
              <div class="lg:py-3">
                <textarea name="" id="" wire:model="healthConcern" cols="10" rows="8" placeholder="Briefly describe the problem"
                  ...
                  @error('healthConcern') <span class="error  text-red-500">{{ $message }}</span> @enderror
              </div>
              <button
            ...
            <div class="lg:pt-6 lg:block hidden lg:px-4">
              <button class="text-black text-sm  bg-[#A4CB6A] font-semibold mb-6  text-center py-1.5 px-4 rounded-lg" wire:click="insertPatientData()">Confrom
                & Pay</button>
              <button
                class="border text-black text-sm border-[#D1D5DB] font-semibold shadow-[0px_1px_3px_0px_rgba(0, 0, 0, 0.07)] ml-6 rounded-lg py-1.5 px-4" wire:click="patientCancel">Cancel</button>
      
      
            </div>
          </div> <!-- parent div open  -->
        </div> <!-- main div close  -->
        <div><p>vhashddfjkasgdf</p></div>
      </body>
